      ...
      <div className='listing-details'>
        ...
        <div className="photos">
          {listing.listingPhotoPaths?.map((item) => (
            <img src={`http:localhost:3001/${item.replace("public", "")}`}
              alt='listing-photo' />
          ))}
        </div>
        <h2>{listing.type} in {listing.city},{listing.province},{""}
          {listing.country}</h2>
        <p>
          {listing.GuestCount}guests -{listing.bedroomCount} bedroom(s) -{" "} {listing.bedCount} bed(s) -{listing.bathCount} bathroom(s)
        </p>
        <hr />
        <div className="profile">
          <img src={`http://localhost:30001/${listing.creator.profileImagePath.replace("public", "")}`} alt="" />
